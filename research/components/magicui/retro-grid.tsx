...
// Renders with raw WebGL + a custom GLSL fragment shader (no three.js/ogl
// needed) and falls back to a CSS-only animated grid when WebGL is
...
/*
Galaxy-theme note: an 80s-style perspective grid receding to the horizon,
scrolling continuously via WebGL shader (with graceful CSS fallback). Good
candidate for a "sci-fi horizon / hyperspace floor" background layer, though
its retro-synthwave aesthetic may clash with a soft "galaxy" look unless
recolored (accepts lightLineColor/darkLineColor + opacity). Zero extra npm
deps — raw WebGL1 + GLSL, no three.js/ogl needed.
*/
