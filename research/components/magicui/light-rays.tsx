...
// Install: pnpm dlx shadcn@latest add @magicui/light-rays
// Dependencies: motion
//   npm install motion
...
/*
Galaxy-theme note: soft animated god-rays/light-shaft background effect
(rays fade in/out and gently swing). Could work well layered behind a "sun"
or bright star planet, or as ambient light for the hero section. Fully
color-configurable via the `color` prop (default is a cool blue, easy to
retint to a nebula purple/pink).
*/
