 ...
 * GitHub:  https://github.com/DavidHDev/react-bits/tree/main/src/content/Backgrounds/Threads
 *
 * Dependencies: ogl (WebGL micro-library)
 *   npm install ogl
 *
 * WebGL animated flowing "threads"/lines effect (Perlin-noise-driven line
 * field), optional mouse interaction. Could represent trajectory lines /
 * comet trails / warp streaks between planet sections, or a subtle moving
 * accent layer. Includes IntersectionObserver + document.hidden checks so
 * it pauses rendering when off-screen or tab is hidden -- good perf model
 * to replicate for other canvas-heavy components on a long scroll page.
 *
 * Usage:
 ...
 *
 * Props:
 *   color: [r,g,b] (0-1 floats)   - line color
 *   amplitude: number              - wave amplitude of the lines
 *   distance: number                - vertical spread/offset of the line bundle
 *   enableMouseInteraction: boolean - lines respond to cursor position
 */
import { useEffect, useRef } from 'react';
import { Renderer, Program, Mesh, Triangle, Color } from 'ogl';

import './threads-background.css';
